...
func TestSubscribeAddress(t *testing.T) {
	...
	var (
		...
		addrs      = map[string]string{
			"5HQGHHrz1DMhCP8UkoqJieTRw7KHTjRjLyCujDvu8fPJm5gu": "receiver1",
			"5Fv63SGvkQV8ihfmiXRCp8xUJKZZ1vkQuC9NYGUYTc9LmusK": "sender1",
		}
	)
	...
	scanner.SetRescanBlockHeight(4286826)
