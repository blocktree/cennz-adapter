...
func (bs *CENNZBlockScanner) SaveLocalBlockHead(blockHeight uint64, blockHash string) error {
...
func (bs *CENNZBlockScanner) GetLocalBlockHead() (uint64, string, error) {
...
func (bs *CENNZBlockScanner) SaveLocalBlock(blockHeader *Block) error {
...
func (bs *CENNZBlockScanner) GetLocalBlock(height uint64) (*Block, error) {
...
func (bs *CENNZBlockScanner) SaveUnscanRecord(record *openwallet.UnscanRecord) error {
...
func (bs *CENNZBlockScanner) DeleteUnscanRecord(height uint64) error {
...
func (bs *CENNZBlockScanner) GetUnscanRecords() ([]*openwallet.UnscanRecord, error) {
